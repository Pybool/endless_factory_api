...
urlpatterns = [
    ...
    path("admin_create_company/", views.admin_create_company, name="admin_create_company"),
    ...
    #Api
    path("alljobs/", views_api.CareerJobsViewAll.as_view()),
    path("jobs/application/", views_api.SubmitJobApplicationView.as_view())
